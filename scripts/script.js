...
function enterSlider(slider)
{
    ...
    {
        document.getElementById("left-slider-arrow-outfit2").className = "swiper-button-style swiper-button-position-left left-outfit2 outfit-swipe-prev swiper-button-switch";
        document.getElementById("right-slider-arrow-outfit2").className = "swiper-button-style swiper-button-position-right right-outfit2 outfit-swipe-prev swiper-button-switch";
    }
